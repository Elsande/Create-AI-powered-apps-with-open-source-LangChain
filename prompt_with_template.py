...
os.environ["OPEN_API_AI"] = openai_api_key

# Mendifinisikan model AI
llm = ChatOpenAI(
...
prompt = PromptTemplate(
    ...
    template="Yang terhormat HRD Manajer {perusahaan},\n\nDengan surat ini, saya [NAMA KAMU], ingin melamar untuk posisi {posisi} di {perusahaan}. Saya memiliki pengalaman di bidang {keterampilan}. \n\nHormat saya,\n[NAMA KAMU]",
)
